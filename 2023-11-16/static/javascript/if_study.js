...
var parkingTime=parseInt(prompt(" 주차시간을 분단위로 입력하세요 "));
var money = 1000 ;

if(parkingTime<120){
    if(parkingTime<40){
        alert(" 주차요금은 1000원입니다.");
    }
    else{
        parkingTime =(parkingTime-30)/10;
        money = (parseInt(money + parkingTime * 100))/100;
        money = (parseInt(money))*100;

        alert("주차요금은 " + money + "원 입니다.");
    }
} else if(parkingTime>=120&& parkingTime <240){
    money = 1500;
    parkingTime =(parkingTime-120)/10;
    money = (parseInt(money + parkingTime * 100))/100;
    money = (parseInt(money))*100;

    alert("주차요금은 " + money + "원 입니다.");
}
else if(parkingTime>=240&& parkingTime <480){
    money = 2500;
    parkingTime =(parkingTime-240)/10;
    money = (parseInt(money + parkingTime * 100))/100;
    money = (parseInt(money))*100;

    alert("주차요금은 " + money + "원 입니다.");
}else{
    alert("주차요금은 10000원 입니다.");
}
